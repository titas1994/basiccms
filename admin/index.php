...
<div class="row">
    ...
    <?php
        ...
        $unapproved_user_role = mysqli_num_rows($select_user_role);
        ...
        var data = google.visualization.arrayToDataTable([
          ['Data', 'Count'],
            ...
            <?php
                ...
                $element_text = ['All Posts','Active Post','Draft Posts','Comments','Unapproved Comments','Users','Subcriber','Categories'];
                $element_count = [$post_counts,$post_published_counts ,$post_draft_counts,$comments_counts,$unapproved_comments,$user_counts,$unapproved_user_role,$categories_counts];
